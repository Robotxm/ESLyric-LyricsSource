 ...
 * Version: 0.1
 * License: GPL 3.0
 * Description: A pure JavaScript implementation of the decryption algorithm for QRC lyrics from QQMusic.
...
export function decryptQrcBytes(content) {
...
export function decryptQrc(content) {
    if (!content) {
        return null
    }
